...
- feat: flatten NavigationDrawerContent sub components in tree ([@olivierpascal](https://github.com/olivierpascal))
...
- feat(PopoverBase): preventAutoFocus prop ([@olivierpascal](https://github.com/olivierpascal))
...
# v0.0.460 (Thu Aug 22 2024)

#### ⚠️ Pushed to `main`

- fix(PopoverBase): styles ([@olivierpascal](https://github.com/olivierpascal))
...
# v0.0.459 (Thu Aug 22 2024)

#### ⚠️ Pushed to `main`

- fix(ListItem, AppLayoutNavigationDrawer, AppLayoutAside): styles ([@olivierpascal](https://github.com/olivierpascal))
...
# v0.0.458 (Thu Aug 22 2024)

#### ⚠️ Pushed to `main`

- fix(NavigationRail): styles ([@olivierpascal](https://github.com/olivierpascal))
...
- fix(NavigationDrawerContentDestination): styles ([@olivierpascal](https://github.com/olivierpascal))
...
- fix(AppLayout): styles ([@olivierpascal](https://github.com/olivierpascal))
...
# v0.0.453 (Thu Aug 22 2024)

#### ⚠️ Pushed to `main`

- fix(List): styles ([@olivierpascal](https://github.com/olivierpascal))
...
- feat(Item): supports density ([@olivierpascal](https://github.com/olivierpascal))
...
- feat(Expandable): initiallyExpanded prop ([@olivierpascal](https://github.com/olivierpascal))
...
- fix: RTG import ([@olivierpascal](https://github.com/olivierpascal))
...
- fix(Stepper): bullet point icon size ([@olivierpascal](https://github.com/olivierpascal))
...
- feat(DisclosurePanel): removed padding ([@olivierpascal](https://github.com/olivierpascal))
...
- fix(useRipple): control was not correct ([@olivierpascal](https://github.com/olivierpascal))
...
- feat: visualState and rippleEffect now support overlaps ([@olivierpascal](https://github.com/olivierpascal))
...
# v0.0.120 (Thu Mar 21 2024)

#### ⚠️ Pushed to `main`

- fix: use floating-ui to handle floating elements ([@olivierpascal](https://github.com/olivierpascal))
...
- feat: better styles for Disclosure button ([@olivierpascal](https://github.com/olivierpascal))
...
- feat: Disclosure component ([@olivierpascal](https://github.com/olivierpascal))
...
# v0.0.115 (Wed Mar 20 2024)

#### ⚠️ Pushed to `main`

- feat: Breadcrumbs does not specify font anymore ([@olivierpascal](https://github.com/olivierpascal))
...
# v0.0.114 (Wed Mar 20 2024)

#### ⚠️ Pushed to `main`

- fix: MenuList styles in Select and Combobox ([@olivierpascal](https://github.com/olivierpascal))
...
- fix: inconsistent value when Combobox is nullable ([@olivierpascal](https://github.com/olivierpascal))
...
- feat: Combobox: selectOnFocus prop ([@olivierpascal](https://github.com/olivierpascal))
...
# v0.0.107 (Fri Mar 15 2024)

#### ⚠️ Pushed to `main`

- fix: controlled and uncontrolled states of Select and Combobox ([@olivierpascal](https://github.com/olivierpascal))
...
- feat: support max in Select and Combobox ([@olivierpascal](https://github.com/olivierpascal))
...
- fix: ListItem has correct type prop when type is button ([@olivierpascal](https://github.com/olivierpascal))
...
- fix: disabled state is working for Select ([@olivierpascal](https://github.com/olivierpascal))
...
# v0.0.96 (Mon Mar 11 2024)

#### ⚠️ Pushed to `main`

- fix: css layer priorities ([@olivierpascal](https://github.com/olivierpascal))
...
# v0.0.94 (Mon Mar 11 2024)

#### ⚠️ Pushed to `main`

- feat: List now exports Item and Divider ([@olivierpascal](https://github.com/olivierpascal))
...
- fix: Switch always uses custom icons if provided ([@olivierpascal](https://github.com/olivierpascal))
...
# v0.0.90 (Mon Mar 11 2024)

#### ⚠️ Pushed to `main`

- fix: try to fix modern-normalize.css import ([@olivierpascal](https://github.com/olivierpascal))
...
- feat: Dialog is now polymorphic ([@olivierpascal](https://github.com/olivierpascal))
...
- fix: no unused ref in RadioGroup ([@olivierpascal](https://github.com/olivierpascal))
...
- feat: expose some hooks ([@olivierpascal](https://github.com/olivierpascal))
...
- fix: Card use correct combined states ([@olivierpascal](https://github.com/olivierpascal))
...
- fix: Card now forward refs ([@olivierpascal](https://github.com/olivierpascal))
...
# v0.0.66 (Sun Mar 03 2024)

#### ⚠️ Pushed to `main`

- refactor: Ripple -> StateLayer ([@olivierpascal](https://github.com/olivierpascal))
...
# v0.0.65 (Sun Mar 03 2024)

#### ⚠️ Pushed to `main`

- doc: TODO updated ([@olivierpascal](https://github.com/olivierpascal))
- fix: dragged state for Card component ([@olivierpascal](https://github.com/olivierpascal))
...
- fix: allow image filter in CardMedia ([@olivierpascal](https://github.com/olivierpascal))
...
- refactor: placeholder color role -> dim ([@olivierpascal](https://github.com/olivierpascal))
...
- feat: default button is now the filled variant ([@olivierpascal](https://github.com/olivierpascal))
...
- feat: Breadcrumbs separators no have a size ([@olivierpascal](https://github.com/olivierpascal))
...
- fix: export to esm ([@olivierpascal](https://github.com/olivierpascal))
...
# v0.0.52 (Thu Feb 29 2024)

#### ⚠️ Pushed to `main`

- chore: added react, react-dom and stylex in peer dependencies ([@olivierpascal](https://github.com/olivierpascal))
...
- feat: CardMedia content is now centered in flex ([@olivierpascal](https://github.com/olivierpascal))
...
- hotfix: padding in CardContent ([@olivierpascal](https://github.com/olivierpascal))
...
# v0.0.41 (Sun Feb 25 2024)

#### ⚠️ Pushed to `main`

- hotfix: replacing margin with padding in CardContent ([@olivierpascal](https://github.com/olivierpascal))
...
# v0.0.40 (Sun Feb 25 2024)

#### ⚠️ Pushed to `main`

- Various updates ([@olivierpascal](https://github.com/olivierpascal))
...
- Added declarationMap in tsconfig.json ([@olivierpascal](https://github.com/olivierpascal))
...
- Various updates related to lib usage ([@olivierpascal](https://github.com/olivierpascal))
...
- Tab with badge [#9](https://github.com/sixui/ui/pull/9) ([@olivierpascal](https://github.com/olivierpascal))
