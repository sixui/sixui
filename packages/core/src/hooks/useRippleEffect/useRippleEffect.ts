...
export const useRippleEffect = <TElement extends HTMLElement>(
  ...
  const handlePointerUp: React.PointerEventHandler = useCallback(
    ...
    [shouldReactToEvent, startPressAnimation, propagateEvents],
  );
  ...
  const handleClick: React.MouseEventHandler = useCallback(
    ...
    [disabled, startPressAnimation, endPressAnimation, propagateEvents],
  );
  ...
  const handleKeyDown: React.KeyboardEventHandler = useCallback(
    ...
    [disabled, startPressAnimation, propagateEvents],
  );
