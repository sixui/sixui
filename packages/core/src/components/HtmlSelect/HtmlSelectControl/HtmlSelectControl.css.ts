...
export type IHtmlSelectControlThemeFactory = IComponentThemeFactory<{
  styleName: keyof typeof classNames;
  variant: IFieldBaseVariant;
}>;

export const htmlSelectControlTheme =
  componentThemeFactory<IHtmlSelectControlThemeFactory>({
    classNames,
    tokensClassName,
    tokens,
  });
