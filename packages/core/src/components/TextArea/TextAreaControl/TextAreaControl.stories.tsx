...
import type { ITextAreaControlProps } from './TextAreaControl.types';
...
} satisfies Partial<ITextAreaControlProps>;

const states: Array<IComponentPresentation<ITextAreaControlProps>> = [
  { legend: 'Normal' },
...
const rows: Array<IComponentPresentation<ITextAreaControlProps>> = [
  { legend: 'Empty' },
...
const TextAreaControlShowcase = componentShowcaseFactory(TextAreaControl);
...
export const Filled: IStory = {
  render: (props) => (
    <TextAreaControlShowcase props={props} cols={states} rows={rows} />
  ),
  args: {
    ...defaultArgs,
    variant: 'filled',
