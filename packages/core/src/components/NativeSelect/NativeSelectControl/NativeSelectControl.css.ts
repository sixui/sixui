...
export type INativeSelectControlThemeFactory = IComponentThemeFactory<{
  styleName: keyof typeof classNames;
  variant: IFieldBaseVariant;
}>;

export const nativeSelectControlTheme =
  componentThemeFactory<INativeSelectControlThemeFactory>({
    classNames,
    tokensClassName,
    tokens,
  });
