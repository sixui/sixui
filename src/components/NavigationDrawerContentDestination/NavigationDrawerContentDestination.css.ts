...
export type INavigationDrawerContentDestinationThemeFactory =
...
export const navigationDrawerContentDestinationTheme =
  componentThemeFactory<INavigationDrawerContentDestinationThemeFactory>({
    classNames,
    tokensClassName,
    tokens,
  });
