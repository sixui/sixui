...
const vars: Partial<IStyleVars<IItemStyleVarKey>> = {
  ...
  overlineTracking: typescaleVars.labelTracking$sm,
  ...
  supportingTextTracking: typescaleVars.bodyTracking$md,
  ...
  trailingSupportingTextTracking: typescaleVars.labelTracking$sm,
